  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", { class: "divider-inner" }, null, -1)
      ]), 2);
    };
  }
});
...
const Divider = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-6debfb94"]]);
const createIpcOn = (worker) => () => {
  ...
  return new Proxy({}, {
    get: ({}, path) => (...args) => {
      ...
      if (20 === type) return true;
      if (21 === type) return false;
      const buffer = data.subarray(3, 3 + size);
      if (10 === type) {
        if (1 === size) return buffer[0];
      }
      if (11 === type) {
...
const handleIpcOn = (worker) => (selfIpc) => {
  worker.addEventListener("message", async ({ data: messageData }) => {
    if ("invoke" === messageData.type) {
      ...
      const data = new Int32Array(sab);
      if (void 0 === ret) data[2] = 0;
      else if (null === ret) data[2] = 1;
      else switch (typeof ret) {
        case "number":
          data[1] = 2;
          data[2] = 11;
          const view = new DataView(data.subarray(3, 5).buffer);
...
const uneval = (value) => {
  switch (typeof value) {
    ...
    case "object":
      ...
      if (Array.isArray(value)) return `[ ${value.map(uneval).join(", ")} ]`;
      if (value instanceof RegExp) return value.toString();
      return `{ ${Object.entries(value).map(([key, value2]) => `${JSON.stringify(key)}:${uneval(value2)}`).join(",")} }`;
  }
};
...
class IpcWorkerFactory {
  getCodeUrl(def2) {
    if (this.codeUrlCache.has(def2)) return this.codeUrlCache.get(def2);
    {
      const code = [
        ...Object.entries({
          ...def2.dependencies,
  ...
  createWorker(def2) {
    console.clear();
    const codeUrl = this.getCodeUrl(def2);
  ...
  constructor(windowIpc) {
    _define_property(this, "windowIpc", void 0);
    _define_property(this, "codeUrlCache", void 0);
    this.windowIpc = windowIpc;
    this.codeUrlCache = /* @__PURE__ */ new Map();
  }
}
const testWorker = () => {
...
const AutoTextarea = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-eca13243"]]);
const _hoisted_1 = { class: "root" };
const _hoisted_2 = { class: "main" };
const _hoisted_3 = { class: "row main-code" };
const _hoisted_4 = { class: "row messages" };
const _hoisted_5 = { class: "messages-content" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const workersEl = ref(null);
    const workerCodeEl = ref(null);
    const panelEl = ref(null);
    const workerId2 = ref(0);
    const workers = shallowReactive({});
    const windowMessages = reactive([]);
    const windowIpc = {
      sleep: (ms) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[4] || (_cache[4] = createBaseVNode("div", { class: "header" }, [
          createBaseVNode("div", null, [
            createBaseVNode("h1", null, "swipc.js"),
            createBaseVNode("p", null, "A TypeScript library supporting synchronous worker IPC")
          ])
        ], -1)),
          ...
          createBaseVNode("div", {
            ...
            createBaseVNode("div", {
              ...
              createBaseVNode("div", {
                ...
                createBaseVNode("div", {
                  class: "row worker-code",
                  ref_key: "workerCodeEl",
                  ref: workerCodeEl
                }, [
                  _cache[0] || (_cache[0] = createBaseVNode("div", { class: "title" }, "Worker Code", -1)),
                  createVNode(AutoTextarea, {
                    spellcheck: "false",
                    "model-value": unref(testWorker).toString()
                  }, null, 8, ["model-value"])
                ], 512),
                createVNode(Divider, {
                  direction: "horizontal",
                  el: workerCodeEl.value
                }, null, 8, ["el"]),
                createBaseVNode("div", _hoisted_3, [
                  _cache[1] || (_cache[1] = createBaseVNode("div", { class: "title" }, "Main Code", -1)),
                  createVNode(AutoTextarea, {
                    spellcheck: "false",
                    "model-value": createWorker.toString()
                  }, null, 8, ["model-value"])
                ])
              ], 512),
              createVNode(Divider, {
              ...
              createBaseVNode("div", {
                ...
                createBaseVNode("div", {
                  ...
                  createBaseVNode("div", { class: "title" }, [
                    _cache[2] || (_cache[2] = createTextVNode(" Workers ")),
                    createBaseVNode("div", null, [
                      createBaseVNode("button", { onClick: createWorker }, "Create worker")
                    ])
                  ]),
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(workers), (_worker, id) => {
                    return openBlock(), createElementBlock("div", {
                      key: id,
                      class: "worker"
                ...
                createBaseVNode("div", _hoisted_4, [
                  _cache[3] || (_cache[3] = createBaseVNode("div", { class: "title" }, "Messages", -1)),
                  createBaseVNode("div", _hoisted_5, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(windowMessages, (message) => {
